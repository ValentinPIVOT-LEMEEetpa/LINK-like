class Scene16 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('background16', 'assets/map/16.png');
		this.load.image('bord46', 'assets/bordure/TOP&BOT.png');
 ...
 */
	...
	create(){
		this.add.image(400, 300, 'background16');
		this.next = this.physics.add.staticGroup();
		this.next.create(400,1,'bord46');
		this.next2 = this.physics.add.staticGroup();
		this.next2.create(400,599,'bord47');
		/*this.next3 = this.physics.add.staticGroup();
		this.next3.create(,,'bord48');
*/
