class Scene23 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('background23', 'assets/map/23.png');
		this.load.image('bord67', 'assets/bordure/TOP&BOT.png');
		this.load.image('bord68', 'assets/bordure/TOP&BOT.png');
		//this.load.image('bord69', 'assets/bordure/.png');
 ...
 */
	...
	create(){
		this.add.image(400, 300, 'background23');
		this.next = this.physics.add.staticGroup();
		this.next.create(400,1,'bord67');
		this.next2 = this.physics.add.staticGroup();
		this.next2.create(400,599,'bord68');
		/*this.next3 = this.physics.add.staticGroup();
		this.next3.create(,,'bord69');
*/
