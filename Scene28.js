class Scene28 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('background28', 'assets/map/28.png');
		this.load.image('bord82', 'assets/bordure/TOP&BOT.png');
		this.load.image('bord83', 'assets/bordure/LEFT&RIGHT.png');
		//this.load.image('bord84', 'assets/bordure/.png');
 ...
 */
	...
	create(){
		this.add.image(400, 300, 'background28');
		this.next = this.physics.add.staticGroup();
		this.next.create(400,1,'bord82');
		this.next2 = this.physics.add.staticGroup();
		this.next2.create(799,300,'bord83');
		/*this.next3 = this.physics.add.staticGroup();
		this.next3.create(,,'bord84');*/
