class Scene29 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('background29', 'assets/map/29.png');
		this.load.image('bord85', 'assets/bordure/LEFT&RIGHT.png');
		this.load.image('bord86', 'assets/bordure/TOP&BOT.png');
		//this.load.image('bord87', 'assets/bordure/.png');
		...
		this.load.spritesheet('e_back-3', 'assets/personnage/ennemi/ennemi-3/ALIVE/BACK-Sheet.png',{frameWidth: 38, frameHeight: 66});
		this.load.spritesheet('e_front-3', 'assets/personnage/ennemi/ennemi-3/ALIVE/FRONT-Sheet.png',{frameWidth: 38, frameHeight: 66});
	}
 ...
 */
	...
	create(){
		this.add.image(400, 300, 'background29');
		this.next = this.physics.add.staticGroup();
		this.next.create(1,300,'bord85');
		this.next2 = this.physics.add.staticGroup();
		this.next2.create(400,1,'bord86');
		/*this.next3 = this.physics.add.staticGroup();
		this.next3.create(,,'bord87');*/
		...
		this.ennemi = this.physics.add.sprite(555,555,'e_back-3');
