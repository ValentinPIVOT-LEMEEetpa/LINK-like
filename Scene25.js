class Scene25 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('background25', 'assets/map/25.png');
		this.load.image('bord73', 'assets/bordure/TOP&BOT.png');
		this.load.image('bord74', 'assets/bordure/LEFT&RIGHT.png');
		//this.load.image('bord75', 'assets/bordure/.png');
 ...
 */
	...
	create(){
		this.add.image(400, 300, 'background25');
		this.next = this.physics.add.staticGroup();
		this.next.create(400,1,'bord73');
		this.next2 = this.physics.add.staticGroup();
		this.next2.create(799,300,'bord74');
		/*this.next3 = this.physics.add.staticGroup();
		this.next3.create(,,'bord75');*/
		...
		this.ennemi = this.physics.add.sprite(100,300,'e_left-2');
