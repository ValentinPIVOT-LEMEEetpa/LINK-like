class Scene19 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('background19', 'assets/map/19.png');
		this.load.image('bord55', 'assets/bordure/TOP&BOT.png');
		this.load.image('bord56', 'assets/bordure/TOP&BOT.png');
		//this.load.image('bord57', 'assets/bordure/.png');
 ...
 */
	...
	create(){
		this.add.image(400, 300, 'background19');
		this.next = this.physics.add.staticGroup();
		this.next.create(400,1,'bord55');
		this.next2 = this.physics.add.staticGroup();
		this.next2.create(400,599,'bord56');
		/*this.next3 = this.physics.add.staticGroup();
		this.next3.create(,,'bord57');*/
