class Scene24 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('background24', 'assets/map/24.png');
		this.load.image('bord70', 'assets/bordure/TOP&BOT.png');
		this.load.image('bord71', 'assets/bordure/TOP&BOT.png');
		//this.load.image('bord72', 'assets/bordure/.png');
 ...
 */
	...
	create(){
		this.add.image(400, 300, 'background24');
		this.next = this.physics.add.staticGroup();
		this.next.create(400,1,'bord70');
		this.next2 = this.physics.add.staticGroup();
		this.next2.create(400,599,'bord71');
		/*this.next3 = this.physics.add.staticGroup();
		this.next3.create(,,'bord72');*/
