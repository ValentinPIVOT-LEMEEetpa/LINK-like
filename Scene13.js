class Scene13 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('background13', 'assets/map/13.png');
		this.load.image('bord37', 'assets/bordure/TOP&BOT.png');
		this.load.image('bord38', 'assets/bordure/LEFT&RIGHT.png');
		this.load.image('bord39', 'assets/bordure/TOP&BOT.png');
 ...
 */
	...
	create(){
		this.add.image(400, 300, 'background13');
		this.next = this.physics.add.staticGroup();
		this.next.create(400,1,'bord37');
		this.next2 = this.physics.add.staticGroup();
		this.next2.create(799,300,'bord38');
		this.next3 = this.physics.add.staticGroup();
		this.next3.create(400,599,'bord39');


		this.cursors = this.input.keyboard.createCursorKeys();

		this.objet = this.physics.add.staticGroup();
		this.objet.create(200,200,'bush').setScale(0.15).refreshBody();
		this.objet.create(150,310,'bush').setScale(0.15).refreshBody();
		this.objet.create(500,530,'bush').setScale(0.15).refreshBody();
		this.objet.create(230,430,'bush').setScale(0.15).refreshBody();
