class Scene27 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('background27', 'assets/map/27.png');
		this.load.image('bord79', 'assets/bordure/LEFT&RIGHT.png');
		this.load.image('bord80', 'assets/bordure/TOP&BOT.png');
		//this.load.image('bord81', 'assets/bordure/.png');
 ...
 */
	...
	create(){
		this.add.image(400, 300, 'background27');
		this.next = this.physics.add.staticGroup();
		this.next.create(1,300,'bord79');
		this.next2 = this.physics.add.staticGroup();
		this.next2.create(400,1,'bord80');
		/*this.next3 = this.physics.add.staticGroup();
		this.next3.create(,,'bord81');*/
