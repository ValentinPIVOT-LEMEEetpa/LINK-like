class Scene30 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('poney', 'assets/decors/MAISONvillageBREE-PONEY.png')
 ...
 */
	...
	create(){
		...
		this.objet.create(700,100,'bree').setScale(2).refreshBody();
		this.objet.create(100,100,'bree').setScale(2).refreshBody();
		this.objet.create(410,400,'poney').setScale(2).refreshBody();


		this.player = this.physics.add.sprite(400,40,'left');
