class Scene12 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('background12', 'assets/map/12.png');
		this.load.image('bord34', 'assets/bordure/LEFT&RIGHT.png');
		this.load.image('bord35', 'assets/bordure/TOP&BOT.png');
		//this.load.image('bord36', 'assets/bordure/.png');
 ...
 */
	...
	create(){
		this.add.image(400, 300, 'background12');
		this.next = this.physics.add.staticGroup();
		this.next.create(1,300,'bord34');
		this.next2 = this.physics.add.staticGroup();
		this.next2.create(400,599,'bord35');
		/*this.next3 = this.physics.add.staticGroup();
		this.next3.create(,,'bord36');*/
		...
		this.objet.create(200,500,'bree').setScale(2).refreshBody();
		...
		this.ennemi = this.physics.add.sprite(700,100,'e_left-4');
