class Scene26 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('background26', 'assets/map/26.png');
		this.load.image('bord76', 'assets/bordure/LEFT&RIGHT.png');
		this.load.image('bord77', 'assets/bordure/TOP&BOT.png');
		this.load.image('bord78', 'assets/bordure/LEFT&RIGHT.png');
 ...
 */
	...
	create(){
		this.add.image(400, 300, 'background26');
		this.next = this.physics.add.staticGroup();
		this.next.create(1,300,'bord76');
		this.next2 = this.physics.add.staticGroup();
		this.next2.create(400,1,'bord77');
		this.next3 = this.physics.add.staticGroup();
		this.next3.create(799,300,'bord78');
